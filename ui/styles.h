...
#define COL_COVER_B   lv_color_hex(0xBFB3A2)  // neutral cover block (ad/empty) — bottom
#define COL_SHADOW    lv_color_hex(0x000000)  // drop-shadow color (play button)
...
#define COL_COVER_B   lv_color_hex(0x1C1C1F)  // neutral cover block (ad/empty) — bottom
#define COL_SHADOW    lv_color_hex(0x000000)  // drop-shadow color (play button)
...
#define RAD_CARD      16
#define RAD_COVER     26   // V2 hero cover (172px)
...
// Sizes are scaled up ~15% from the original 480px mockup so the 2.16" panel
// reads at arm's length (see scripts/gen_fonts.sh for the per-role mapping).
LV_FONT_DECLARE(inter_extrabold_33);
LV_FONT_DECLARE(inter_extrabold_13);
LV_FONT_DECLARE(inter_semibold_19);
LV_FONT_DECLARE(inter_semibold_15);
LV_FONT_DECLARE(inter_semibold_14);
LV_FONT_DECLARE(inter_regular_12);
#define FONT_TITLE    (&inter_extrabold_33)  // display title 33 / 800
#define FONT_LABEL    (&inter_extrabold_13)  // status row 13 / 800 uppercase
#define FONT_BODY     (&inter_semibold_19)   // artist 19 / 600
#define FONT_META     (&inter_semibold_15)   // album 15 / 600
#define FONT_TIME     (&inter_semibold_14)   // elapsed / total 14 / 600
#define FONT_ICON     (&inter_semibold_19)   // transport glyph text fallback
